								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" checked="checked" id="method-boleto" name="metodo-pagamento" placeholder="boleto" value="1" style="float: left; margin: 30px;">
											<label class="" for="method-boleto"><img style="height:64px;" src="/res/site/img/banco.png"><h4>Pagamento via boleto bancário</h4></label>
										     </p>

										     <br/>
										     <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" id="method-pagseguro" name="metodo-pagamento" placeholder="pagseguro" value="2" style="float: left; margin: 30px;">
											<label class="" for="method-pagseguro"><img style="height:64px;" src="/res/site/img/logo-pagseguro.png"></label>
										     </p>

										     <br/>
										     <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" id="method-paypal" name="metodo-pagamento" placeholder="paypal" value="3" style="float: left; margin: 30px;">
