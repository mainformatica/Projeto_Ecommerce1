<?php if(!class_exists('Rain\Tpl')){exit;}?>s<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php } ?>
            <!-- form start -->
            <form role="form" action="/admin/pedidos/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" method="post">
                <div class="box-body">
