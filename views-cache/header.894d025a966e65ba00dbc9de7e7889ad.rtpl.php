...
<head>
  ...
  <title>Painel Administrativo | TicketsShow</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>TicketsShow</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Marco Aurélio - Web Developer
                  <small>Membro desde AGO. 2003</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/pedidos"><i class="fa fa-shopping-cart"></i> <span>Pedidos</span></a></li>
        <li class="treeview">
